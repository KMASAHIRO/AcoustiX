...
def run_doa_all_tx(
    base_dir="./custom_scene/real_env_Smooth_concrete_painted/real_env_Smooth_concrete_painted",
    fs=16000,
    n_fft=512,
    mic_radius=0.0365,
    algo_names=None,
...
if __name__ == "__main__":
    run_doa_all_tx(base_dir="./custom_scene/real_env_Smooth_concrete_painted/real_env_Smooth_concrete_painted_16kHz")

...
def process_rx_directory(rx_dir: Path, save_dir: Path):
    ...
    for f in ir_files:
        ...
        ir_data_all.append({
            ...
            "orientation_rx": data["orientation_rx"],
            "orientation_tx": data["orientation_tx"]
        })
    ...
    for ch_idx, f_data in enumerate(ir_data_all):
        ...
        np.savez(
            ...
            orientation_rx=f_data["orientation_rx"],
            orientation_tx=f_data["orientation_tx"],
            ch_idx=ch_idx
        )
...
output_root = Path("./custom_scene/real_env_Smooth_concrete_painted/real_env_Smooth_concrete_painted_centered")
